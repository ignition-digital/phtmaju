...
<!-- Mirrored from palingcita.com/cn/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Feb 2025 10:16:09 GMT -->
<head>
    <!-- Site Title-->
    <title>私人贷款 - Pht Maju Sdn Bhd</title>
              ...
              <div class="unit unit-sm-horizontal unit-spacing-md">
                ...
                <div class="unit-body">
                  <div class="post-title">
                    <h3 class="line-height-12">私人贷款</h3>
                  </div>
                  <div class="post-body">
                    <p>我们专注给予您最好的财务状况分析，并了解您的需求来给于您最有效的贷款方案 .</p>
                    <p>我们的财务顾问能了解你所面对的问题，并提供一定提供您正确的解决方案，同时也不会让您的还款方式受到影响.</p>
                  </div>
                  ...
                  <br />
                    <div class="cell-xs-6 cell-md-12 offset-top-41 offset-xs-top-0 offset-md-top-41">
                      ...
                      <ul class="list list-marked-gray offset-top-15">
                        <li><a href="#">3个月工资单用于固定收入的员工</a></li>
                        <li><a href="#">3个月工资的银行对帐单 （来往或储蓄户口）</a></li>
                        <li><a href="#">身份证副本</a></li>
                        <li><a href="#">最新电单,水单</a></li>
                      </ul>
          ...
          <div class="shell-fluid shell-fluid-mod-1">
            <div class="range range-condensed range-xs-center features-list">
              <div class="cell-sm-6 cell-lg-3"><a class="thumbnail-variant-1 thumbnail-features"><span class="icon icon-xl text-primary thin-icon-thumb-up"></span>
                  <div class="caption">
                    <h3 class="text-primary"> 高数额的贷款</h3>
                    <p class="text-base">我们公司专为您提供个人贷款和商业贷款等，让您能立即解决您的财务问题.</p>
                  </div></a></div>
              <div class="cell-sm-6 cell-lg-3"><a class="thumbnail-variant-1 thumbnail-features"><span class="icon icon-xl text-primary thin-icon-checklist"></span>
                  <div class="caption">
                    <h3 class="text-primary">快速批准</h3>
                    <p class="text-base">如您能达到我们公司的最低要求，我们能迅速批准您的贷款.</p>
                  </div></a></div>
              <div class="cell-sm-6 cell-lg-3"><a class="thumbnail-variant-1 thumbnail-features"><span class="icon icon-xl text-primary thin-icon-briefcase-2"></span>
                  <div class="caption">
                    <h3 class="text-primary"> 适合的还款计划</h3>
                    <p class="text-base">我们会先了解您的财务状况，并为您设计一个能减轻您的负担的还款计划.</p>
                  </div></a></div>
              <div class="cell-sm-6 cell-lg-3"><a class="thumbnail-variant-1 thumbnail-features"><span class="icon icon-xl text-primary thin-icon-money"></span>
                  <div class="caption">
                    <h3 class="text-primary">最低的利息</h3>
                    <p class="text-base">如您能达到我们公司的最低要求,我们会以最低的1%利息来计算您的还款计划，这不仅让您节省，并能彻底解决你的财务问题.</p>
                  </div></a></div>
            </div>
          </div>
        </section>
          ...
          <div class="shell">
            <div class="range">
              <div class="cell-md-8 cell-lg-12">
                <h3>不要再担心你的财务问题了 !!</h3>
                <p>立即联络我们的热线 <b><a href="tel:+60192779748" class="text-middle">019-2779748</a></b> </p><p>让我们的财务顾问解决您的金钱烦恼!!</p>
              </div>
            </div>
          </div>
        </section>
      ...
      <footer class="page-foot bg-dark text-center text-sm-left">
        <section class="footer-content">
          <div class="shell clearfix">   
            ...
            <p class="pull-sm-left offset-top-0">&#169; <span id="copyright-year"></span> Pht Maju Sdn Bhd. All Rights Reserved. <a href="index-5.html" class="icon-primary">Privacy Policy</a></p>	            
          </div>
        </section>
      </footer>
...
<!-- Mirrored from palingcita.com/cn/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Feb 2025 10:16:10 GMT -->
</html>