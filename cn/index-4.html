...
<!-- Mirrored from palingcita.com/cn/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Feb 2025 10:16:13 GMT -->
<head>
    <!-- Site Title-->
    <title>联络我们 - Pht Maju Sdn. Bhd.</title>
              ...
              <div class="rd-navbar-nav-inner justify-between display-flex align-center">
                <div class="rd-navbar-nav-wrap">
					<ul class="rd-navbar-nav">
						...
						<li class="active"><a href="index-4.html">联络我们</a></li>
          ...
          <div class="shell">
            ...
            <div class="range range-xs-center offset-top-20 text-sm-left">
                ...
                <div class="range offset-top-30">
                  <div class="cell-sm-6 cell-md-12">
                    ...
                    <div class="unit unit-sm-horizontal unit-spacing-md unit-sm-top offset-top-30 offset-sm-top-18">
                      ...
                      <div class="unit-body">
                        <h5>立即联络:</h5><a href="tel:+60192779748" class="text-base text-middle">019-2779748</a> <img src="images/Whatsapp.png">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="cell-md-8 cell-lg-preffix-1">
                <h3 class="text-center">其他询问</h3>
                <!-- RD Mailform-->
                <form data-form-output="form-output-global" data-form-type="contact" method="post" action="https://palingcita.com/cn/bat/rd-mailform.php" class="rd-mailform text-left form-contact-line offset-top-30">
                  <div class="form-inline-login">
                    <div class="form-group">
                      <label for="contact-name" class="form-label form-label-outside">
						姓名</label>
                      <input id="contact-name" type="text" name="name" placeholder="您的姓名" data-constraints="@Required" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="contact-name" class="form-label form-label-outside">
						电话号码</label>
                      <input id="contact-name" type="text" name="phone" placeholder="您的电话号码" data-constraints="@Required" class="form-control">
                    </div>                    
                  </div>
                  <div class="form-group offset-top-18 offset-xs-top-30 offset-sm-top-12">
					...
					信息</label>
                    <textarea id="contact-message" name="message" placeholder="您的信息" data-constraints="@Required" class="form-control"></textarea>
                  </div>
