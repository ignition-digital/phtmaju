...
<!-- Mirrored from palingcita.com/en/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Feb 2025 10:16:21 GMT -->
<head>
    <!-- Site Title-->
    <title>Enquiry - Pht Maju Sdn. Bhd.</title>
...
function checkfield(){
	...
	if (chkok == true){
		document.ContactForm.action  = "index-5.html";
        ...
        <section class="section-66 section-sm-top-70 section-sm-bottom-83 text-center">
          <div class="shell">
            ...
            <form method="POST" name="ContactForm">
                ...
                <font color="#CCCCCC">
                <input type="radio" value="V3" checked name="R1"></font> Personal Loans <font color="#FF0000">*</font><font color="#CCCCCC"><br>
                </font><font color="#CCCCCC">
                <input type="radio" name="R1" value="V2"></font> Collateral Loans<font color="#CCCCCC">
                </font>
            	<font color="#0000FF">
                *</font></p>
                ...
                <tr>
                    <td width="30%" valign="top">
                        <p class="body_text" align="left">
                            <font size="2">Name</font><font size="2" color="#FF0000"> *</font></p>
                    </td>
                    <td width="70" valign="top" align="left">
                        <p>
                            <font size="2" color="#000000">
                                <font color="#000000"  size="2">
                                <input type="text" name="Name" size="50" style="background-color: #C5C5C5"></font></font></p>
                    </td>
                </tr>
                <tr>
                    <td width="30%" valign="top" height="48">
                        <p class="body_text" align="left">
                            <font size="2">Email </font><font color="#FF0000" size="2">*</font><font color="#CCCCCC" size="2"> </font>
                    		</td>
                ...
                <tr>
                    <td width="30%" valign="top" height="48">
						<p class="body_text" align="left">
							<font size="2">Home Address</font><font size="2" color="#FF0000">*</font>
						</p>					
                            </td>
                    <td width="70" valign="top" align="left" height="48">
                            <font color="#000000" size="2">
                ...
                <tr>
                    <td width="30%" valign="top">
                            <p class="body_text" align="left"><font size="2">Suitable Time to Contact You</font><font size="2" color="#FF0000">*</font></p>
                            </td>
                    <td width="70" valign="top" align="left">
                        <font color="#000000">
                ...
                <tr>
                    <td width="30%" valign="top">
                        <p class="body_text" align="left">
                            <font size="2">Company Name</font><font size="2" color="#CCCCCC"> </font><font size="2" color="#FF0000">*</font></p>
                    </td>
                    <td width="70" valign="top" align="left">
                        <p>
                            <font color="#000000" size="2">
                ...
                <tr>
                    <td width="30%" valign="top">
                        <p class="body_text" align="left">
                            <font size="2">Occupation</font><font size="2" color="#CCCCCC"> </font><font size="2" color="#FF0000">*</font></p>
                    </td>
                    <td width="70" valign="top" align="left">
                        <p>
                            <font color="#000000" size="2">
                    ...
                    <td width="30%" valign="top" align="left">
						...
						<font size="2">Employee No</font></td>
                    <td width="70" valign="top" align="left">
                ...
                <tr>
                    <td width="30%" valign="top">
                        <p class="body_text" align="left">
                            <font size="2">Office Address</font><font size="2" color="#FF0000"> *</font></p>
                    </td>
                    <td width="70" valign="top" align="left">
                        <p>
                            <font color="#000000" size="2">
                    ...
                    <td width="30%" valign="top" align="left">
                            <span class="text-middle">
							<font size="2">Office Telephone</font>
                ...
                <tr>
                    <td width="30%" valign="top">
                        <p class="body_text" align="left">
                            <font size="2">Salary</font><font size="2" color="#FF0000"> *</font></p>
                    </td>
                    <td width="70" valign="top" align="left">
                        <p>
                            <font color="#000000" size="2">
                ...
                <tr>
                    <td width="30%" valign="top">
                        <p class="body_text" align="left">
                            <font size="2">Salary From </font><font size="2" color="#FF0000">*</font></p>
                    </td>
                    <td width="70" valign="top" align="left">
                        <p>
                            <font color="#000000">
                ...
                <tr>
                    <td width="30%" valign="top">
                        <p class="body_text" align="left">
                            <font size="2">Working Duration</font><font size="2" color="#FF0000"> *</font></p>
                    </td>
                    <td width="70" valign="top" align="left">
                        <p>
                            <font color="#000000" size="2">
                            <input type="text" name="Duration" size="25" style="background-color: #C5C5C5"> </font>
                            <font size="2">eg 3 years 1 months</font></p>
                    </td>
                </tr>
                <tr>
                    <td width="30%" valign="top">
                        <p class="body_text" align="left">
                            <font size="2">Home Type </font><font size="2" color="#FF0000">*</font></p>
                    </td>
                    <td width="70" valign="top" align="left">
                        <p>
                            <font color="#000000">
                            <select size="1" name="Home" style="background-color: #C5C5C5">
                                <option selected value="">--- Choose One --- </option>
                                <option value="Sendiri">Own</option>
                                <option value="Sewa">Rental</option>
                                <option value="Keluarga">Family</option>
                                <option value="Sewa Bilik">Room Rental</option>
                            </select></font></p>
                    </td>
                </tr>
                <tr>
                    <td width="30%" valign="top">
                        <p class="body_text" align="left">
                            <font size="2">Loan Amount</font><font size="2" color="#FF0000"> *</font></p>
                    </td>
                    <td width="70" valign="top" align="left">
                        <p>
                            <font color="#000000" size="2">
                ...
                <tr>
                    <td width="30%" valign="top">
                        <p class="body_text" align="left">
                            <font size="2">Collateral Item</font><font size="2" color="#0000FF"> *</font></p>
                    </td>
                    <td width="70" valign="top" align="left">
                        <p>
                            <font color="#000000" size="2">
                ...
                <tr>
                    <td width="30%" valign="top" >
                        <p class="body_text" align="left">
                            <font size="2">Collateral Value</font><font size="2" color="#0000FF"> *</font></p>
                    </td>
                    <td width="70" valign="top" align="left">
                        <p>
                            <font color="#000000" size="2">
                ...
                <tr>
                    <td width="30%" valign="top">
                        <p class="body_text" align="left">
                            <font size="2">Any Question</font></p>
                    </td>
                    <td width="70" valign="top" align="left">
                        <font color="#000000" size="2">
            ...
            <p class="body_text" align="center">&nbsp;
                <input type="button" value="  Send  " name="B3" onclick="checkfield();">
