...
<!-- Mirrored from palingcita.com/en/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Feb 2025 10:16:13 GMT -->
<head>
    <!-- Site Title-->
    <title>Contact Us - Pht Maju Sdn. Bhd.</title>
  ...
  <body>
    ...
    <div class="page text-center">
                ...
                <div class="rd-navbar-nav-wrap">
					<ul class="rd-navbar-nav">
						...
						<li><a>B.Malaysia/中文</a>
							<ul class="rd-navbar-dropdown">
								<li><a href="../index-4.html">B.Malaysia</a></li>
								<li><a href="../cn/index-4.html">中文</a></li>
							</ul>
						</li>
      ...
      <main class="page-content">
        <section class="section-50 section-sm-bottom-100 text-center">
          <div class="shell">
            <h2>Contact Us</h2>
              ...
              <div class="cell-md-4 cell-lg-3">
                ...
                <div class="range offset-top-30">
                  <div class="cell-sm-6 cell-md-12">
                    <div class="unit unit-sm-horizontal unit-spacing-md unit-sm-top">
                      <div class="unit-left min-width-sm"><span class="icon icon-sm text-primary fa-map-o"></span></div>
                      <div class="unit-body">
                        <h5>Our Address:</h5><a class="text-gray">
						No. 57-1, Jalan Inang 3, Taman Paya Rumput Utama, 76450 Melaka</a>
                      </div>
                    </div>
                    <div class="unit unit-sm-horizontal unit-spacing-md unit-sm-top offset-top-30 offset-sm-top-18">
                      <div class="unit-left min-width-sm"><span class="icon icon-sm text-primary fa-phone"></span></div>
                      <div class="unit-body">
                        <h5>Contact Us Now:</h5><a href="tel:+60192779748" class="text-base text-middle">019-2779748</a> <img src="images/Whatsapp.png">
                      </div>
                    </div>
                  </div>
                </div>
              </div>
              <div class="cell-md-8 cell-lg-preffix-1">
                <h3 class="text-center">Other Enquiry</h3>
                <!-- RD Mailform-->
                <form data-form-output="form-output-global" data-form-type="contact" method="post" action="https://palingcita.com/en/bat/rd-mailform.php" class="rd-mailform text-left form-contact-line offset-top-30">
                  <div class="form-inline-login">
                    <div class="form-group">
                      <label for="contact-name" class="form-label form-label-outside">
						Name</label>
                      <input id="contact-name" type="text" name="name" placeholder="Your Name" data-constraints="@Required" class="form-control">
                    </div>
                    <div class="form-group">
                      <label for="contact-mail" class="form-label form-label-outside">
						Email</label>
                      <input id="contact-mail" type="text" name="email" placeholder="mail@mail.com" data-constraints="@Required @Email" class="form-control">
                    </div>
                    <div class="form-group">
                      <label for="contact-name" class="form-label form-label-outside">
						Telephone</label>
                      <input id="contact-name" type="text" name="phone" placeholder="Your Telephone" data-constraints="@Required" class="form-control">
                    </div>                    
                  </div>
                  <div class="form-group offset-top-18 offset-xs-top-30 offset-sm-top-12">
                    <label for="contact-message" class="form-label form-label-outside">
					Message</label>
                    <textarea id="contact-message" name="message" placeholder="Your Message" data-constraints="@Required" class="form-control"></textarea>
                  </div>
                  <button type="submit" class="btn btn-primary-variant-2 btn-md">
					Hantar</button>
                </form>
              </div>
            </div>
        ...
        <section>
			<iframe src="https://www.google.com/maps/d/u/9/embed?mid=1JkFr_lzJVFH1in2qLjtEniYy2hM" width="1250" height="800"></iframe>
        </section>
