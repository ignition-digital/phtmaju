...
<!-- Mirrored from palingcita.com/en/index-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Feb 2025 10:16:39 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <!-- Site Title-->
    <title>Thank You  - Pht Maju Sdn. Bhd.</title>
  ...
  <!-- Google Code for email Conversion Page -->
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 851028577;
var google_conversion_language = "en";
var google_conversion_format = "3";
var google_conversion_color = "ffffff";
var google_conversion_label = "vJlHCOn2wHEQ4dTmlQM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/851028577/?label=vJlHCOn2wHEQ4dTmlQM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
    ...
    <div class="page text-center">
      ...
      <main class="page-content">
        <section class="section-66 section-sm-top-70 section-sm-bottom-83 text-center">
          <div class="shell">
            <h2>Thank You </h2>
            	 <h5>Our Customer Service Will Contact You As Soon As Possible!!</h5>     
                                        <Br>  
                    <img src="images/thanks-en.jpg">
          </div>
        </section>
