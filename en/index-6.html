...
<!-- Mirrored from palingcita.com/en/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Feb 2025 10:16:45 GMT -->
<head>
    <!-- Site Title-->
    <title>Privacy Policy - Pht Maju Sdn. Bhd.</title>
  ...
  <body>
    ...
    <div class="page text-center">
                ...
                <div class="rd-navbar-nav-wrap">
					<ul class="rd-navbar-nav">
						...
						<li><a>B.Malaysia/中文</a>
							<ul class="rd-navbar-dropdown">
								<li><a href="../index-7.html">B.Malaysia</a></li>
								<li><a href="../cn/index-5.html">中文</a></li>
							</ul>
						</li>
      ...
      <!-- Privacy Policy-->
      <section class="text-center text-sm-left section-50 section-sm-top-70 section-sm-bottom-83">
        <div class="shell">
          <h2 class="text-center">Privacy policy</h2>
          <div class="range range-xs-center offset-top-32">
            <div class="cell-sm-10 cell-md-8">
              <div data-type="accordion" class="responsive-tabs responsive-tabs-classic text-left">
                <ul data-group="tabs-group-default" class="resp-tabs-list tabs-group-default">
                  <li class="h6 text-sbold">WHAT INFORMATION DO WE COLLECT?</li>
                  <li class="h6 text-sbold">WHAT DO WE USE YOUR INFORMATION FOR?</li>
                  <li class="h6 text-sbold">HOW DO WE PROTECT YOUR INFORMATION?</li>
                  <li class="h6 text-sbold">DO WE USE COOKIES?</li>
                  <li class="h6 text-sbold">DO WE DISCLOSE ANY INFORMATION TO OUTSIDE PARTIES?</li>
                  <li class="h6 text-sbold">ONLINE PRIVACY POLICY ONLY</li>
                  <li class="h6 text-sbold">YOUR CONSENT</li>                  
                </ul>
                <div data-group="tabs-group-default" class="resp-tabs-container tabs-group-default">
                  <div>
                    We collect information from you when you fill out a form. When registering on our site, as appropriate, you may be asked to enter your: name, e-mail address, mailing address, phone number or Loan Amount, etc. You may, however, visit our site anonymously.
                  </div>
                  <div>
                  - Loan Application : The information that you provide for application, may be used to send you information or contact you direct on the contact number provided by you during our processing. 
					<br>- Blacklist Checking : We may use the personal identification number provided by you to check on your existing debt.
                  </div>
                  <div>
