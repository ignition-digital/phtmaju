...
<!-- Mirrored from palingcita.com/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Feb 2025 10:15:59 GMT -->
<head>
    <!-- Site Title-->
    <title>Hubungi Kami - Pht Maju Sdn. Bhd.</title>
              ...
              <div class="rd-navbar-nav-inner justify-between display-flex align-center">
                <div class="rd-navbar-nav-wrap">
					<ul class="rd-navbar-nav">
						...
						<li class="active"><a href="index-4.html">Hubungi Kami</a></li>
						<li><a>EN/中文</a>
							<ul class="rd-navbar-dropdown">
								<li><a href="en/index-4.html">English</a></li>
          ...
          <div class="shell">
            ...
            <div class="range range-xs-center offset-top-20 text-sm-left">
                ...
                <div class="range offset-top-30">
                  <div class="cell-sm-6 cell-md-12">
                    <div class="unit unit-sm-horizontal unit-spacing-md unit-sm-top">
                      ...
                      <div class="unit-body">
                        <h5>Alamat Kami:</h5><a class="text-gray">
                    ...
                    <div class="unit unit-sm-horizontal unit-spacing-md unit-sm-top offset-top-30 offset-sm-top-18">
                      ...
                      <div class="unit-body">
                        <h5>Hubungi Kami:</h5><a href="tel:+60192779748" class="text-base text-middle">019-2779748</a> <img src="images/Whatsapp.png">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="cell-md-8 cell-lg-preffix-1">
                <h3 class="text-center">Pertanyaan Lain</h3>
                <!-- RD Mailform-->
                <form data-form-output="form-output-global" data-form-type="contact" method="post" action="https://palingcita.com/bat/rd-mailform.php" class="rd-mailform text-left form-contact-line offset-top-30">
                  <div class="form-inline-login">
                    <div class="form-group">
                      <label for="contact-name" class="form-label form-label-outside">
						Nama</label>
                      <input id="contact-name" type="text" name="name" placeholder="Nama Anda" data-constraints="@Required" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="contact-name" class="form-label form-label-outside">
						Telefon</label>
                      <input id="contact-name" type="text" name="phone" placeholder="Telefon Anda" data-constraints="@Required" class="form-control">
                    </div>                    
                  </div>
                  <div class="form-group offset-top-18 offset-xs-top-30 offset-sm-top-12">
					...
					Mesej</label>
                    <textarea id="contact-message" name="message" placeholder="Mesaj Anda" data-constraints="@Required" class="form-control"></textarea>
                  </div>
